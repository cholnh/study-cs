...
- 있으나 마나 한 주석
    + 너무 당연한 사실을 언급하며 새로운 정보를 제속하지 못하는 주석
...
- 너무 많은 정보
    + 주석에다 흥미로운 역사나 관련 없는 정보를 정활하게 늘어놓지 마라.  
...
```java
/*
 * 모든 픽셀을 담을 만큼 풍분한 배열로 시작한다(여기에 필터 바이트를 더한다).
 ...
 * 에라스토테네스의 체다.
 * <p>
 * 에라스토테네소: 기원전 276년에 리비아 키레네에서 출생, 기원전 194년에 사망
